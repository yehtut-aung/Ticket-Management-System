...
SECRET_KEY = 'django-insecure-w=q9k4sgy#=5(@7dcln4ibv#m@3r0evgk%&o3!jtq5i0ao2bbd'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Updated 6_March_2026
ALLOWED_HOSTS = ['ticketsystem.onrender.com', 'localhost','127.0.0.1']
...
# Add this for security in production by deepseek
